...
class TeamAssigner:
    ...
    def get_player_team(self, frame, player_bbox, player_id):
        ...
        team_id += 1  # since we have only 2 clusters, we can add 1 to the team id to make it 1 or 2

       # if player_id == goalkeeperid: # To fix any future potential goalkeeper scenarios
        #    team_id = histeam_id
